...
for (let btn of btns) {
    // btn은 5개씩 [0,1,2,3,4]를 하나씩 꺼내서 btn에 넣어주기
    btn.addEventListener("click", (e) => {
        ...
        switch(str) {
            ...
            case "before" :
                ...
                div1.innerText = count; // div의 내용으로 count를 추가
                                                     // (TextNode 사용 안하는 방법)
